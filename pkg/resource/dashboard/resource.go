...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.DashboardID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f2, ok := fields["dashboardID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: dashboardID"))
	}
	r.ko.Spec.DashboardID = &f2
