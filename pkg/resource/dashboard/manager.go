...
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=dashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=dashboards/status,verbs=get;update;patch
