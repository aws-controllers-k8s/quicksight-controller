...
const (
	FinalizerString = "finalizers.quicksight.services.k8s.aws/Brand"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("brands")
