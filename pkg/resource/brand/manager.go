...
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=brands,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=brands/status,verbs=get;update;patch
