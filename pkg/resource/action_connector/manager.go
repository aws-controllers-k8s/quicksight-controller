...
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=actionconnectors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=actionconnectors/status,verbs=get;update;patch
