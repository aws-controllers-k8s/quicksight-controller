...
const (
	FinalizerString = "finalizers.quicksight.services.k8s.aws/ActionConnector"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("actionconnectors")
	GroupKind            = metav1.GroupKind{
		Group: "quicksight.services.k8s.aws",
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ActionConnector{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ActionConnector),
	}
}
