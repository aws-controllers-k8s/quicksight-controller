...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.AnalysisID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["analysisID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: analysisID"))
	}
	r.ko.Spec.AnalysisID = &primaryKey
