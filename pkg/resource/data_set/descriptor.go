...
const (
	FinalizerString = "finalizers.quicksight.services.k8s.aws/DataSet"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("datasets")
