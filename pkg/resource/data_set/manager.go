...
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=datasets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=quicksight.services.k8s.aws,resources=datasets/status,verbs=get;update;patch
