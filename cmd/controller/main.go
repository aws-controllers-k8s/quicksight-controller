...
import (
	...
	_ "github.com/aws-controllers-k8s/quicksight-controller/pkg/resource/action_connector"
	_ "github.com/aws-controllers-k8s/quicksight-controller/pkg/resource/brand"

	"github.com/aws-controllers-k8s/quicksight-controller/pkg/version"
)

var (
	awsServiceAPIGroup = "quicksight.services.k8s.aws"
	awsServiceAlias    = "quicksight"
